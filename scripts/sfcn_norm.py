...
def sfcn_layer_norm(idx, only_evaluate=False, name = 'sfcn_layer_norm'):
    index=int(idx)
...
def sfcn_no_norm(idx, only_evaluate=False, name = 'sfcn_no_norm'):
    index=int(idx)
...
def sfcn_group_norm4(idx, only_evaluate=False, name = 'sfcn_group_norm4'):
    index=int(idx)
...
def sfcn_group_norm8(idx, only_evaluate=False, name = 'sfcn_group_norm8'):
    index=int(idx)
...
def sfcn_group_norm16(idx, only_evaluate=False, name = 'sfcn_group_norm16'):
    index=int(idx)
...
def sfcn_wnorm8(idx, only_evaluate=False, name = 'sfcn_wnorm8'):
    index=int(idx)
...
def sfcn_wnorm16(idx, only_evaluate=False, name = 'sfcn_wnorm16'):
    index=int(idx)
